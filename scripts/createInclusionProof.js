      ...
      .then(async (module) => {
        ...
        try {
          ...
          const txInclusionProof =
            await txInclusionSdk.getTransactionInclusionProof(executedTxHash);
          ...
          // Submit the proof to the proving smart contract
          ...
          const tx = await contract.claimReward(txInclusionProof); // replace with your contract's function name

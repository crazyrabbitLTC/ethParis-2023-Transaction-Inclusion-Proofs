...
async function proposeTransaction() {
  ...
  try {
    ...
    const txServiceUrl = process.env.GEORLI_TX_SERVICE || 'https://safe-transaction-goerli.safe.global'
    ...
    fs.writeFileSync('safeData.json', JSON.stringify({ ...safeData, safeTxHash }))
